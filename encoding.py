...
expName = 'Mem_Encoding'  # from the Builder filename that created this script
expInfo = {'participant': ''}
...
filename = _thisDir + os.sep + u'data_encoding/%s_%s_%s' %(expInfo['participant'], expName, expInfo['date'])

# An ExperimentHandler isn't essential but helps with data saving
thisExp = data.ExperimentHandler(name=expName, version='',
    extraInfo=expInfo, runtimeInfo=None,
    originPath='/Users/leallab/Library/CloudStorage/Box-Box/Leal Lab/Behavioral Tasks/In-Person Tasks/Memorability Reboot (115)/memorability task/encoding.py',
